...
| Constantin Knapp | Synthetic data generation and finetuning (one gpt call)  |
| Constantin Knapp | Synthetic data generation and finetuning (two gpt calls) |
| Constantin Knapp | Synthetic data generation  and finetuning (sudoku puzzles)               |
| Constantin Knapp | Data processing for synthetic data                       |
