...
def evaluate(args: argparse.Namespace) -> Dict[str, float]:
    ...
    # === Also print plain text versions for easy logging/parsing
    print(f"Question_Macro_F1: {avg_question_f1}")
    print(f"Statement_Macro_F1: {avg_statement_f1}")
    print(f"Statement_Evidence_Macro_F1: {avg_relation_f1}")
    print(f"Reasoning_F1: {avg_reasoning_f1}")
